...
class AudioHandler:
    def __init__(self, config):
        self.config = config
        self.audio_feature_type = config.arch.TATER.audio_feature_type
        self.num_audio_features = config.arch.TATER.num_audio_features
        self.audio_window_size = config.arch.TATER.audio_window_size
        self.audio_window_stride = config.arch.TATER.audio_window_stride
