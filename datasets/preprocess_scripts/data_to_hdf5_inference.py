...
def save_to_hdf5(root_directory, hdf5_path, log_file_path, gpus, tasks_per_gpu):
    active_processes = []
    ...
    video_titles = sorted(os.listdir(root_directory))
    ...
    for video_title, transcript_title in zipped_titles:
        ...
        video_encoding_proc = Process(target=process_video, args=(root_directory, video_title, transcript_title, log_file_path, available_gpu, prev_process, lock, gpu_queue))
...
if __name__ == "__main__":
    ...
    save_to_hdf5(input_dir, output_file, log_file_path, gpus, tasks_per_gpu)
